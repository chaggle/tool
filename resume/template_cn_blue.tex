...
\firstname{陈}
\familyname{之恒}
\title{chaggle}               % 可选项目，可以使用 % 符号注释
\address{杭州}{}                      
\address{1999/10/23}{}    
\mobile{18684750413}                    
%\fax{fax (optional)}                          
\email{939735759@qq.com}                     
%\homepage{Blog: http://geekplux.com} 
\social[github]{GitHub: https://github.com/chaggle}
\extrainfo{%
  Leetcode: https://leetcode-cn.com/u/chaggle/ \\
  WeChat: 18684750413 \\
  QQ: 939735759
}
...
%  凑字数员工奖}
\section{教育经历}
\cventry{17.09-21.06}{本科}{长沙理工大学}{网络工程}{}{}                % arguments 3 to 6 are optional
...
\section{技能}
\cvline{\textbf{语言}}{熟练使用c++、python}
\cvline{\textbf{数据结构}}{熟练掌握线性表、链表、栈、队列、数组、树等数据结构以及基础查找
与排序算法的内容}
